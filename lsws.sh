#!/bin/bash
##############################################################################
# bash ols1clk.sh -a 'ols@!oneClick' -e cisco@gmail.com  --lsphp 72 -w -r 'soporteT1user!' 
--dbname 'web' --dbuser 'lsws' --dbpassword 'Castill0!' --wpuser 'juan' --wppassword 'soporteT1user!@' 
--wplang es_ES --sitetitle 'zara'
##############################################################################
